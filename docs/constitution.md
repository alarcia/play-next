...
2. **La spec manda.** No se escribe código que no derive de una spec aprobada; si la implementación debe desviarse, primero se actualiza la spec. Si falta una decisión, se para y se pregunta al usuario: nunca se supone.
